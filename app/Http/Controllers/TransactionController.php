...
class TransactionController extends Controller
{
                       ...
                       <div class="cell">
                            <div>
                                ...
                                <a class=" btn like btn-link btn-icon btn-fab btn-info btn-sm " 
                                    ...
                                    <i data-v-01e1f50f="" class="tim-icons icon-zoom-split"></i>
                                 </a>
    ...
    {
        $items = TransactionItem::with(['product'])->where('transactions_id', $transaction->id)->get();
        ...
        return view('pages.dashboard.transaction.show', compact('transaction', 'items'));
    }
