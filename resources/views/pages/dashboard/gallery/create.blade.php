                ...
                <form action="{{ route('dashboard.product.gallery.store',  $product->id) }}" method="POST"
                    ...
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        <div class="fileinput-new thumbnail">
                            <img src="https://white-dashboard-pro-laravel.creative-tim.com/white/img/image_placeholder.jpg"
                                alt="...">
                        </div>
                        <div class="fileinput-preview fileinput-exists thumbnail"></div>
                        <div>
                            <span class="btn btn-rose btn-round btn-file">
                                <input type="file" multiple accept="image/*" value="{{ old('files') }}" name="files[]">
                            </span>

                        </div>
                    </div>
                    <button class="btn btn-primary" type="submit">Simpan Foto</button>
