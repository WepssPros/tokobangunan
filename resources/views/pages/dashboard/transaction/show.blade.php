...
<div class="h-full bg-gray-200 p-8">
    <div class="bg-white rounded-lg shadow-xl pb-8">
        ...
        <div class="flex flex-col items-center -mt-20">
            <img src="{{$transaction->user->profile_photo_url}}" class="w-40 border-4 border-white rounded-full">
            <div class="flex items-center space-x-2 mt-2">
                <p class="text-2xl">{{$transaction->user->name}}</p>
            ...
            <p class="text-sm text-gray-500">Jambi JMB</p>
        </div>
    ...
    <div class="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
        <div class="w-full flex flex-col 2xl:w-1/3">
            <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                ...
                <ul class="mt-2 text-gray-700">
                    ...
                    <li class="flex border-b py-2">
                        ...
                        <span class="text-gray-700">{{$transaction->user->email}}</span>
                    </li>
                    <li class="flex border-b py-2">
                        <span class="font-bold w-24">Username:</span>
                        <span class="text-gray-700">{{$transaction->user->username}}</span>
                    </li>
                    <li class="flex border-b py-2">
                        <span class="font-bold w-24">Bergabung:</span>
                        <span class="text-gray-700">{{$transaction->user->created_at}}</span>
                    </li>
            ...
            <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
                <h4 class="text-xl text-gray-900 font-bold">Pesanan Dibuat</h4>
                <div class="relative px-4">
                    ...
                    <div class="flex items-center w-full my-6 -ml-1.5">
                        ...
                        <div class="w-11/12">
                            <p class="text-sm">Invoice ID<a href="#"
                                    class="text-blue-600 font-bold">#{{$transaction->id}}</a> was
                                created.</p>
                            <p class="text-xs text-gray-500">{{$transaction->updated_at}}</p>
                        </div>
                    </div>
                    <!-- end::Timeline item -->
                    ...
                    <div class="flex items-center w-full my-6 -ml-1.5">
                        ...
                        <div class="w-11/12">
                            ...
                            <p class="text-xs text-gray-500">{{$transaction->payment}}</p>
                        </div>
                    </div>
                    <!-- end::Timeline item -->
                    ...
                    <div class="flex items-center w-full my-6 -ml-1.5">
                        ...
                        <div class="w-11/12">
                            <p class="text-sm">New order received Shipping Price.</p>
                            <p class="text-xs text-gray-500">Rp.{{number_format($transaction->shipping_price)}}</p>
                        </div>
                    </div>
                    <!-- end::Timeline item -->
    ...
    <div class="bg-white rounded-lg shadow-xl p-8">
        <div class="flex items-center justify-between">
            <h4 class="text-xl text-gray-900 font-bold">Item Yang Di Pesan ({{$items->count()}})</h4>
        ...
        <div
            ...
            <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-blue-600"
                title="View Profile">
                <img src="{{$item->product->galleries->first()->url}}" class="w-16 rounded-full">
                <p class="text-center font-bold text-sm mt-1">{{$item->product->name}}</p>
                <p class="text-xs text-gray-500 text-center">{{$item->product->category->name}}</p>
                <p class="text-xs text-gray-500 text-center">Qty {{$item->quantity}}</p>
            </a>
            @endforeach
